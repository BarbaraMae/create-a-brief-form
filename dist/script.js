...
$("#editBrief").click(function () {
  $("#results").hide();
  $("#questions").show();
  document.getElementById("copyIcon").classList.remove("bi-check-lg");
  document.getElementById("copyIcon").classList.add("bi-clipboard-plus-fill");
});
  ...
  const copyContent = async () => {
    try {
      ...
      document
        ...
        .classList.remove("bi-clipboard-plus-fill");
